...
from .version_tagger import VersionTaggerComponent  # noqa: F401
from .registry import apply_registered_components
from .converter import doc_to_entities

# Register the content_version_extractor factory.
from ..version import content_extractor  # noqa: F401
