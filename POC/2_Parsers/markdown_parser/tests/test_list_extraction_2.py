...
"""
        ...
        assert len(docs) == 1
        doc = docs[0]
        assert "lists" in doc.source_metadata
        assert len(doc.source_metadata["lists"]) == 2
        
        # First list should be bullet list
        bullet_list = doc.source_metadata["lists"][0]
        ...
        numbered_list = doc.source_metadata["lists"][1]
...
"""
        ...
        doc = docs[0]
        assert "lists" in doc.source_metadata
        assert doc.source_metadata["lists"] == []
