...
try:
    from client.base_client import BaseEmbeddingClient, EmbeddingClientError  # standalone mode
    ...
    from embeddings.client.base_client import BaseEmbeddingClient, EmbeddingClientError  # package mode
    from embeddings.models.embedding_result import EmbeddingInputType, EmbeddingResult
    from embeddings.services.embedding_service import (
        _build_metadata,
        _entity_input_type,
        _entity_text,
        _is_non_retryable,
